 ...
 * @Description TODO 简单的聊天服务处理器
 * TODO 从 handler （处理器）的实现开始，handler 是由 Netty 生成用来处理 I/O 事件的。
 *
 * SimpleChannelInboundHandler 简单的通道入站处理  父类是 ChannelInboundHandlerAdapter 通道入站处理程序适配器
 * TODO
 * <p>
...
// 现在仅仅只需要继承 SimpleChannelInboundHandler 类而不是你自己去实现接口方法。
    ...
    public void handlerAdded(ChannelHandlerContext ctx) throws Exception {
        ...
        // Broadcast a message to multiple Channels  将消息广播到多个频道
    ...
    public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
        ...
        // A closed Channel is automatically removed from ChannelGroup, 关闭的 Channel 会自动从 ChannelGroup 中移除，
        // so there is no need to do "channels.remove(ctx.channel());"  所以不需要手动移除
    }
