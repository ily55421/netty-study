    ...
    public void run() throws Exception {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
                    ...
                    // TODO 接收连接 option() 是提供给NioServerSocketChannel 用来接收进来的连接。
            ...
            // 这里我们在机器上绑定了机器所有网卡上(本机地址)的 8080 端口。当然现在你可以多次调用 bind() 方法(基于不同绑定地址)。
